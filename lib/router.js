...
router.namespace = function (namespace, fn) {
  ...
  if (middleware.length > 1) middleware = compose(middleware);else middleware = middleware[0];
...
router.match = function () {
  var action, controller, controllerAction, method, middlewares, options, path, _i, _ref;
  path = arguments[0], middlewares = 4 <= arguments.length ? _slice.call(arguments, 1, _i = arguments.length - 2) : (_i = 1, []), controllerAction = arguments[_i++], options = arguments[_i++];
